!(function(n) {
  "use strict";
  (n.fn.novacancyID = void 0 === n.fn.novacancyID ? 0 : n.fn.novacancyID),
    (n.fn.novacancy = function(i) {
        ...
        new (function(i, o) {
          ...
          if (
            ...
            (this.css = function(n) {
              ...
              null !== t.color &&
                ((i += "color: " + t.color + ";"),
                (o += "color: " + t.color + "; opacity: 0.3;")),
                null !== t.glow &&
                  (i += a += "text-shadow: " + t.glow.toString() + ";");
              var l = "";
              return (
                (l += n + " .novacancy." + t.classOn + " { " + i + " }\n"),
            ...
            (this.reblink = function(n) {
              setTimeout(function() {
                r.rand(1, 100) <= t.reblinkProbability
                  ? r.blink(n)
                  : (n[0].blinking = !1);
              }, r.rand(t.blinkMin, t.blinkMax));
            }),
            ...
            (this.htmlString = function() {
              var i = "";
              return (
                n.each(s.contents(), function(o, a) {
                  if (3 == a.nodeType) {
            ...
            (this.randomArray = function(n) {
              ...
              for (i = 0; i < n; ++i) a[i] = i;
              for (i = 0; i < n; ++i)
                (t = a[(o = parseInt(Math.random() * n, 10))]),
                  (a[o] = a[i]),
                  (a[i] = t);
              return a;
            }),
            (this.loop = function() {
              ...
              a &&
                0 !== c.length &&
                ((n = c[r.rand(0, c.length - 1)]),
                (i = e.eq(n))[0].blinking || r.blink(i),
